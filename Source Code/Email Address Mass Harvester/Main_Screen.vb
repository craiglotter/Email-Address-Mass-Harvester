...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ToolTip1.SetToolTip(Me.txtSearchString, "The search string searched for during the Email Address Mass Harvester operation")
        '
        'txtReplaceString
        '
        ...
        Me.txtReplaceString.ReadOnly = True
        Me.txtReplaceString.Size = New System.Drawing.Size(224, 20)
        Me.txtReplaceString.TabIndex = 1
        Me.txtReplaceString.Text = ""
        Me.ToolTip1.SetToolTip(Me.txtReplaceString, "The replace string used during the Email Address Mass Harvester operation")
        '
        'Label1
        '
        ...
        Me.ToolTip1.SetToolTip(Me.txtBaseFolder, "The base folder from which the search is initiated during the Email Address Mass " & _
        "Harvester operation")
        '
        'Label2
        '
        ...
        Me.Label3.Text = "ENTER THE DESIRED EMAIL SEARCH PATTERN, SELECT THE OPERATION BASE FOLDER AND RESU" & _
        "LTS FILE AND CLICK ON THE PROCESS BUTTON TO LAUNCH THE EMAIL HARVESTER.  (DELIMI" & _
        "TER: ';;')"
        '
        'ButtonFolderBrowse
        '
        ...
        Me.ToolTip1.SetToolTip(Me.ButtonOperationLaunch, "Launches Email Address Mass Harvester Operation")
        '
        'Button1
        '
        ...
        Me.Button2.Location = New System.Drawing.Point(240, 96)
        Me.Button2.Name = "Button2"
        Me.Button2.Size = New System.Drawing.Size(56, 20)
        Me.Button2.TabIndex = 51
        Me.Button2.Text = "BROWSE"
        Me.ToolTip1.SetToolTip(Me.Button2, "Launches the Folder Browser Dialog")
        '
        'txtStatus
        '
        Me.txtStatus.BackColor = System.Drawing.Color.GhostWhite
        ...
        Me.step4.Name = "step4"
        Me.step4.Size = New System.Drawing.Size(208, 16)
        Me.step4.TabIndex = 35
        Me.step4.Text = "Step 4: Merge and Process Results File"
        '
        'Label5
        '
        ...
        Me.txtFolderRenames.Text = "Final Processing:"
        ...
        Me.SaveFileDialog1.FileName = "Results"
        ...
        Me.Name = "Main_Screen"
        Me.Text = "Email Address Mass Harvester   (20061120.1)"
...
#End Region
    ...
    Private Sub Error_Handler(ByVal ex As Exception, Optional ByVal identifier_msg As String = "")
        ...
        Catch exc As Exception
            ...
            MsgBox("An error occurred in Email Address Mass Harvester's error handling routine. The application will try to recover from this serious error.", MsgBoxStyle.Critical, "Critical Error Encountered")
        End Try
    End Sub
    ...
    Private Sub ButtonOperationLaunch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonOperationLaunch.Click
        ...
        finfo = New FileInfo(replace(0))
        If finfo.Exists = True Then
            DosShellCommand("""" & (Application.StartupPath & "\" & "File Delete To Recycle Bin.exe").Replace("\\", "\") & """ """ & finfo.FullName & """")
        End If
        finfo = Nothing
        finfo = New FileInfo(replace(0) & "1")
        If finfo.Exists = True Then
            DosShellCommand("""" & (Application.StartupPath & "\" & "File Delete To Recycle Bin.exe").Replace("\\", "\") & """ """ & finfo.FullName & """")
        End If
        finfo = Nothing
        finfo = New FileInfo(replace(0) & "2")
        If finfo.Exists = True Then
            DosShellCommand("""" & (Application.StartupPath & "\" & "File Delete To Recycle Bin.exe").Replace("\\", "\") & """ """ & finfo.FullName & """")
        End If
        finfo = Nothing
        finfo = New FileInfo(replace(0) & "3")
        If finfo.Exists = True Then
            DosShellCommand("""" & (Application.StartupPath & "\" & "File Delete To Recycle Bin.exe").Replace("\\", "\") & """ """ & finfo.FullName & """")
        End If
        finfo = Nothing
        finfo = New FileInfo(replace(0) & "4")
        If finfo.Exists = True Then
            DosShellCommand("""" & (Application.StartupPath & "\" & "File Delete To Recycle Bin.exe").Replace("\\", "\") & """ """ & finfo.FullName & """")
        End If
        finfo = Nothing
        finfo = New FileInfo(replace(0) & "5")
        If finfo.Exists = True Then
            DosShellCommand("""" & (Application.StartupPath & "\" & "File Delete To Recycle Bin.exe").Replace("\\", "\") & """ """ & finfo.FullName & """")
        End If
        finfo = Nothing
    ...
    Public Sub WorkerFolderRenameHandler(ByVal Result As Long, ByVal oftotal As Long)
        Try
            ...
            SendMessage("txtFolderRenames", "Final Processing: Busy")
        Catch ex As Exception
            Error_Handler(ex)
        End Try
    End Sub
    ...
    Public Sub WorkerCompleteHandler(ByVal queue As Integer)
        Try
            ...
            If steps = 5 And eventhandled = False Then
                ...
                SendMessage("txtFolderRenames", "Final Processing: Complete")
                ...
                Dim finfo As FileInfo
                finfo = New FileInfo(txtReplaceString.Text)
    ...
    Public Sub Load_Registry_Values()
        Try
            ...
            For Each str In keys
                If str.Equals("Software\Email Address Mass Harvester") = True Then
                    keyflag1 = True
                    Exit For
                End If
            Next str
            ...
            If keyflag1 = False Then
                oReg.CreateSubKey("Software\Email Address Mass Harvester")
            End If

            keyflag1 = False

            Dim oKey As RegistryKey = oReg.OpenSubKey("Software\Email Address Mass Harvester", True)
            ...
            Else
                configflag = True
                oKey.SetValue("frmsearchstring", "@commerce.uct.ac.za")
                frmsearchstring = ("@commerce.uct.ac.za")
            End If
            ...
            Else
                configflag = True
                oKey.SetValue("frmreplacestring", "C:\Results.txt")
                frmreplacestring = ("C:\Results.txt")
            End If
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            SaveFileDialog1.Title = "Select location for generated results file"


            If SaveFileDialog1.ShowDialog = DialogResult.OK Then
                txtReplaceString.Text = SaveFileDialog1.FileName
            End If

        Catch ex As Exception
            Error_Handler(ex, "Save File Dialog")
        End Try
