    ...
    Private Sub FileContentSearchAndReplace(ByVal filename As String, ByVal thread As Integer)
        Try
            If filetypes.Contains(filename.Substring(filename.Length - 4, 4)) = True Then
                ...
                Dim finfo As FileInfo = New FileInfo((Application.StartupPath & "\Email Address Harvester.exe").Replace("\\", "\"))
                ...
                If finfo.Exists = True Then
                    ...
                    For Each str As String In search
                        ...
                        If Not (search(i) = "" Or search(i) = Nothing) Then
                            ...
                            apptorun = """" & (Application.StartupPath & "\Email Address Harvester.exe").Replace("\\", "\") & """ """ & filename & """ """ & search(i) & """ """ & replace(0) & thread & """ ""minimal"""
                ...
                If c1.Exists Then
                    ...
                    For Each str As String In search
                        ...
                        If Not (search(i) = "" Or search(i) = Nothing) Then
                            ...
                            linetocheck = FastReplace(linetocheck, search(i), replace(0))
                        End If
                        i = i + 1
                    Next
    ...
    Private Sub WorkerFolderRename_Routine()
        ...
        Try
            If stopcheck = False Then
                ...
                'End If
                Dim apptorun As String = """" & (Application.StartupPath & "\" & "Text File Merger.exe").Replace("\\", "\") & """ """ & fname & """"



            finfo = New FileInfo(replace(0) & "1")
            If finfo.Exists = True Then
                    apptorun = apptorun & " """ & finfo.FullName & """"
            End If
            finfo = Nothing
            ...
            finfo = Nothing
                ...
                fname = finfo.FullName
                finfo = Nothing
                apptorun = """" & (Application.StartupPath & "\" & "Distinct and Sorted Text Lines.exe").Replace("\\", "\") & """ """ & fname & """"
                result = DosShellCommand(apptorun)
    ...
    Private Sub FolderRenameRunner(ByVal targetDirectory As String)
        Try
            ...
            For Each str As String In search
                ...
                If Not (search(i) = "" Or search(i) = Nothing) Then
                    'linetocheck = linetocheck.Replace(search(i), replace(i))
                    newname = FastReplace(newname, search(i), replace(0))
                End If
                i = i + 1
            Next
